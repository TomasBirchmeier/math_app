...
class _ImageTrimmer {
  ...
  static Future<Uint8List> trimmedBytes(String assetPath) {
    return _cache.putIfAbsent(assetPath, () async {
      ...
      final isPrivateAsset = assetPath.contains('private_assets/');
      try {
        ...
        final threshold = isPrivateAsset ? 210 : 235;
        ...
        bool columnHasInk(int x) {
          ...
          for (var y = 0; y < height; y++) {
            ...
            if (a < (isPrivateAsset ? 4 : 8)) continue;
        ...
        final padding = isPrivateAsset ? 28 : 22;
        ...
        var blankStreak = 0;
        final gapThreshold = isPrivateAsset ? 110 : 80;
        ...
        if (isPrivateAsset) {
          final minHeight = (height * 0.55).round();
