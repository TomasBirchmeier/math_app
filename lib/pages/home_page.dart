...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  static const String _tagline =
      'Entrena con precisión y monitorea tu avance en segundos.';
  ...
  Widget build(BuildContext context) {
    ...
    final febInfo = ExamCatalog.getById(ExamCatalog.assetM1ExamFebId);
          ...
          child: Column(
            ...
            children: [
              ...
              _ExamCard(
                examId: febInfo.id,
                title: febInfo.title,
                description: febInfo.description,
                questionCount: febInfo.questionCount,
                attempt: febAttempt,
                formatDuration: _formatDuration,
                formatDate: _formatAttemptDate,
                onStart: febAttempt == null
                    ? () => _launchExam(
                        (_) => ExamAssetSessionPage(
                          examId: febInfo.id,
                          examTitle: febInfo.title,
                          questions: ensayoM1Feb2023,
                        ),
                      )
                    : null,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: isLight
            ...
            : null,
        color: isLight ? null : scheme.surfaceVariant.withOpacity(0.9),
        boxShadow: [
          BoxShadow(
            color: scheme.primary.withOpacity(isLight ? 0.18 : 0.08),
            blurRadius: 20,
