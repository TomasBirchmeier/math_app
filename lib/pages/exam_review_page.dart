...
class _ExamReviewPageState extends State<ExamReviewPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Revisión · ${exam.title}')),
      body: Column(
  ...
  List<_ReviewQuestion> _buildQuestions(
    ...
    if (exam.usesAssets) {
      final assetQuestions = _assetQuestionsFor(exam.id);
      for (final question in assetQuestions) {
  ...
  Iterable<ExamQuestionAsset> _assetQuestionsFor(String examId) {
    switch (examId) {
      case ExamCatalog.assetM1ExamId:
        return ensayoM1May2023;
      case ExamCatalog.assetM1ExamFebId:
        return ensayoM1Feb2023;
      default:
        return const <ExamQuestionAsset>[];
    }
  }
            ...
            Center(
              child: ConstrainedBox(
                ...
                child: ClipRRect(
                  ...
                  child: TrimmedAssetImage(assetPath: question.assetPath!),
                ),
              ),
            ),
